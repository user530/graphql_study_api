    ...
    await prisma.duration.createMany({
        data: [
            ...
            },
            {
                ...
                "practicalLessons": null,
                "workshops": 15,
                "modulesDescription": "Курс обучает методам формирования и управления инвестиционным портфелем, диверсификации, анализу рисков, выбору активов и оптимизации доходности",
                "modulesResult": "По завершению программы вы научитесь разрабатывать и применять стратегии управления портфелем, проводить анализ рисков и доходности, оптимизировать портфельные инвестиции и проектировать диверсифицированные инвестиционные стратегии.",
                "videomaterials": 150,
                programId: 2,
            },
            {
                ...
                "practicalLessons": 15,
                "workshops": 40,
                "modulesDescription": "Программа Управление рисками научит оценивать, управлять и минимизировать риски в бизнесе, принимать обоснованные решения и повышать устойчивость компании",
                "modulesResult": "Студенты программы управления рисками изучают методы и инструменты анализа, оценки и управления рисками в бизнесе, разрабатывают стратегии минимизации финансовых, операционных и других видов рисков в организации",
                "videomaterials": 395,
                programId: 3,
            },
            {
                ...
                "practicalLessons": null,
                "workshops": 15,
                "modulesDescription": "На курсе изучаются аспекты корпоративного права и смежных дисциплин в Российской Федерации. Юристы проходят обучение управлению крупными организациями и знакомятся с их правовым режимом",
                "modulesResult": "Изучите корпоративное и договорное право. Научитесь корпоративному управлению. Сможете участвовать в качестве юриста в разрешении корпоративных споров",
                "videomaterials": 120,
                programId: 3,
            }
        ]
